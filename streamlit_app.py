...
if ing_list:
    [st.write(ing_list[fruit]) for fruit in range(len(ing_list)) ]
    sf_res = [requests.get(f"https://my.smoothiefroot.com/api/fruit/{ing_list[fruit]}").json() for fruit in range(len(ing_list))]
